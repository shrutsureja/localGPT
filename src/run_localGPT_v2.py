...
def load_model(device_type, model_id, model_basename=None, LOGGING=logging):
    ...
    logging.info(f"Model : {model_id} received by the load_model function")
    return llm
...
def retrieval_qa_pipline(device_type, use_history, promptTemplate_type="llama"):
    ...
    logging.info(f"Model : {MODEL_ID} received in the retrieval_qa_pipline");
    if use_history:
    ...
    logging.info(f"Model : {MODEL_ID} returning from retrieval_qa_pipline");
    return qa
...
def main(device_type, show_sources, use_history):
    ...
    logging.info(f"returned from retrieval_qa_pipline");
    logging.info(f"goes to the QnA part");
    while True:
